...
Milestone should treat evidence as a first-class submission artifact, not as a loose upload bucket.
...
5. The reviewer approves, adjusts, or pauses the release.
6. The UI presents the evidence pack, its files, the evaluation outcome, and the onchain transaction in one timeline.
